...
const mr = makeLang({
  "nav.overview": "ओव्हरव्ह्यू", "nav.purchaseList": "खरेदी यादी", "nav.marketInsights": "मार्केट इनसाइट्स", "nav.whatIf": "काय-जर सिम्युलेटर", "nav.federated": "पीअर इंटेलिजन्स",
...
const ta = makeLang({
  "nav.overview": "மேலோட்டம்", "nav.purchaseList": "கொள்முதல் பட்டியல்", "nav.marketInsights": "சந்தை நுண்ணறிவு", "nav.whatIf": "என்ன-இருந்தால்", "nav.federated": "பியர் இன்டெலிஜென்ஸ்",
...
const te = makeLang({
  "nav.overview": "అవలోకనం", "nav.purchaseList": "కొనుగోలు జాబితా", "nav.marketInsights": "మార్కెట్ ఇన్‌సైట్స్", "nav.whatIf": "ఏమిటి-అయితే", "nav.federated": "పీర్ ఇంటెలిజెన్స్",
...
const kn = makeLang({
  "nav.overview": "ಅವಲೋಕನ", "nav.purchaseList": "ಖರೀದಿ ಪಟ್ಟಿ", "nav.marketInsights": "ಮಾರುಕಟ್ಟೆ ಒಳನೋಟಗಳು", "nav.whatIf": "ಏನಾದರೆ", "nav.federated": "ಪೀರ್ ಇಂಟೆಲಿಜೆನ್ಸ್",
...
const bn = makeLang({
  "nav.overview": "ওভারভিউ", "nav.purchaseList": "কেনাকাটার তালিকা", "nav.marketInsights": "মার্কেট ইনসাইটস", "nav.whatIf": "কি-যদি", "nav.federated": "পিয়ার ইন্টেলিজেন্স",
...
const gu = makeLang({
  "nav.overview": "ઓવરવ્યૂ", "nav.purchaseList": "ખરીદી યાદી", "nav.marketInsights": "માર્કેટ ઇનસાઇટ્સ", "nav.whatIf": "શું-જો", "nav.federated": "પીઅર ઇન્ટેલિજન્સ",
